...
export default function BannerHacemosSimple() {
  return (
      ...
      <div className="grid items-stretch gap-10 lg:grid-cols-[minmax(320px,32%)_1fr]">
        ...
        <div className="px-5 py-16 lg:pr-10">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-6">
            <a
              href="https://wa.me/573158786701?text=Hola%2C%20quiero%20informaci%C3%B3n%20sobre%20los%20Planes%20de%20Previsi%C3%B3n"
              target="_blank"
