 ...
 * ║  Archivo         : components/BannerHacemosSimple.jsx                  ║
 * ║  Versión         : v1.0.0                                              ║
 * ║  Fecha           : 2026-07-30                                          ║
 * ╠══════════════════════════════════════════════════════════════════════════╣
...
export default async function BannerHacemosSimple() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-gradient-to-br from-white via-stone-50 to-gold-100/40">
      <div className="grid items-stretch gap-10 lg:grid-cols-[minmax(320px,32%)_1fr]">
        {/* Foto — torre de la iglesia de Ábrego */}
        <div className="relative w-full">
          <Image
            src="/banner-hacemos-simple.jpg"
            alt="Funeraria San José de Ábrego — cortejo fúnebre frente a la iglesia de Ábrego"
            width={1200}
            height={1500}
            quality={100}
        ...
        <div className="px-5 py-16 lg:pr-10">
          ...
          <h2 className="mt-3 font-serif text-4xl leading-tight text-brand-900 sm:text-5xl">
            Hacemos simple lo que<br className="hidden sm:block" /> nunca debería ser complicado.
          </h2>
          <p className="mt-3 max-w-xl text-stone-600">
            Pregunta hoy mismo por nuestros <strong className="text-brand-800">Planes de Previsión</strong> y
            deja resuelto, con anticipación y tranquilidad, lo que más te importa.
          </p>
          ...
          <div className="mt-8 flex items-center gap-3 rounded-full bg-gold-500/15 py-2.5 pl-4 pr-6 text-brand-900">
            <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-brand-900 text-gold-400">
              <BenefitIcon name="corazon" className="h-4 w-4" />
            </span>
            <p className="text-sm font-semibold">La excelencia en el servicio, siempre a tu lado.</p>
          </div>

          <div className="mt-8 flex flex-wrap items-center gap-6">
            <a
              href={`https://wa.me/${waNumero}?text=Hola%2C%20quiero%20informaci%C3%B3n%20sobre%20los%20Planes%20de%20Previsi%C3%B3n`}
              target="_blank"
            ...
            >
              ...
              <span className="text-left leading-tight">
                <span className="block text-sm font-bold">Pregúntanos hoy</span>
                <span className="block text-xs text-gold-200">Por WhatsApp</span>
              </span>
            </a>
            ...
            <div className="rounded-2xl border border-brand-900/15 bg-white px-5 py-3">
              <p className="flex items-center gap-2 text-sm font-semibold text-brand-900">
                <BenefitIcon name="escudo" className="h-4 w-4 text-gold-600" />
                Más de 20 años de excelencia en el servicio
              </p>
              <p className="mt-0.5 text-xs text-stone-500">Con respeto, calidez y compromiso.</p>
            </div>
          </div>
